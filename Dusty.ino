...
// Dusty.ino
// 8/12/21
// Group 3 of CSM1038 Computer Applications of Energy Studies
// Code to control the Arduino robot "Dusty" in collision avoidance through use of ultrasonic sensor
//  Adapted from Motor_Functions Example code to control the robot with functions by Ryan Hughes 2019
...
void loop() {                                // The loop routine beigns (running over and over, continuously).
  ...
  while (distance < avoidDistance) {
    ...
    turnOnSpotLeft();
    delay(200);   // how much to turn? keep turning-left-on-spot for 500mS
